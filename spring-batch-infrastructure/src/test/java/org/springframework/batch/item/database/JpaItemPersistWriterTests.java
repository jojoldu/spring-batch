 ...
 * @author jojoldu
 */
public class JpaItemPersistWriterTests {

	EntityManagerFactory emf;

	JpaItemPersistWriter<String> writer;
	...
	public void setUp() throws Exception {
		...
		writer = new JpaItemPersistWriter<>(String.class, emf);
	}

	@Test
	public void testAfterPropertiesSet() throws Exception {
		writer = new JpaItemPersistWriter<>();
		try {
